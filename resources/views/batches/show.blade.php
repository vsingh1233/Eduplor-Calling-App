                    ...
                    <div class="bg-white border rounded-xl p-5 shadow-sm flex flex-col justify-between h-full">
                        <div class="mb-6">
                            ...
                            <div class="flex items-center text-gray-600 text-sm">
                                ...
                                tel:{{ Str::start($lead->phone, '+') }}
                            </div>
                        </div>
                        
                       <a href="tel:{{ Str::start($lead->phone, '+') }}" class="w-full inline-flex items-center justify-center px-6 py-4 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-lg transition-colors text-base shadow-md uppercase tracking-wider">
